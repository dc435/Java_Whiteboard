...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        btnSend = new JButton();
        Font btnSendFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnSend.getFont());
        ...
        btnJoin = new JButton();
        Font btnJoinFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnJoin.getFont());
        if (btnJoinFont != null) btnJoin.setFont(btnJoinFont);
        btnJoin.setText("Join");
        barManage.add(btnJoin);
        btnLeave = new JButton();
        Font btnLeaveFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnLeave.getFont());
        if (btnLeaveFont != null) btnLeave.setFont(btnLeaveFont);
        btnLeave.setText("Leave");
        barManage.add(btnLeave);
        btnOpen = new JButton();
        Font btnOpenFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnOpen.getFont());
        if (btnOpenFont != null) btnOpen.setFont(btnOpenFont);
        btnOpen.setText("Open");
        barManage.add(btnOpen);
        btnNew = new JButton();
        Font btnNewFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnNew.getFont());
        if (btnNewFont != null) btnNew.setFont(btnNewFont);
        btnNew.setText("New");
        barManage.add(btnNew);
        btnSave = new JButton();
        Font btnSaveFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnSave.getFont());
        if (btnSaveFont != null) btnSave.setFont(btnSaveFont);
        btnSave.setText("Save");
        barManage.add(btnSave);
        btnSaveAs = new JButton();
        Font btnSaveAsFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnSaveAs.getFont());
        if (btnSaveAsFont != null) btnSaveAs.setFont(btnSaveAsFont);
        btnSaveAs.setText("Save as");
        barManage.add(btnSaveAs);
        btnBoot = new JButton();
        Font btnBootFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnBoot.getFont());
        if (btnBootFont != null) btnBoot.setFont(btnBootFont);
        btnBoot.setText("Boot User");
        barManage.add(btnBoot);
        btnClose = new JButton();
        Font btnCloseFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnClose.getFont());
        if (btnCloseFont != null) btnClose.setFont(btnCloseFont);
        btnClose.setText("Close");
        barManage.add(btnClose);
        btnUserName = new JButton();
        Font btnUserNameFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnUserName.getFont());
        ...
        Font btnServerFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnServer.getFont());
        ...
        Font btnTriangleFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnTriangle.getFont());
        ...
        Font btnFreeHandFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnFreeHand.getFont());
        ...
        Font btnRectangleFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnRectangle.getFont());
        ...
        Font btnCircleFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnCircle.getFont());
        if (btnCircleFont != null) btnCircle.setFont(btnCircleFont);
        btnCircle.setText("Circle");
        barShape.add(btnCircle);
        btnLine = new JButton();
        Font btnLineFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnLine.getFont());
        if (btnLineFont != null) btnLine.setFont(btnLineFont);
        btnLine.setText("Line");
        barShape.add(btnLine);
        btnTextCanvas = new JButton();
        Font btnTextCanvasFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, btnTextCanvas.getFont());
        ...
        Font barColorFont = this.$$$getFont$$$("JetBrains Mono", Font.PLAIN, 12, barColor.getFont());
